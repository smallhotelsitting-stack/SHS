          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-3 items-center h-28 md:h-32 gap-4">
              ...
              <div className="flex justify-center items-center">
                <Link to={`/${currentLang}`} className="flex items-center justify-center h-16 md:h-24 px-2">
                  <img src="/system-images/translogotext.png" alt="Small Hotel Sitting Logo Text" className="h-full w-auto object-contain" />
                </Link>
              </div>
